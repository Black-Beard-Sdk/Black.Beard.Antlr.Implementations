#nullable disable
// Generated by ScriptClassVisitorWithProperties.cs (samedi 15 avril 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.Parsers.TSql
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        /// 	 : ALTER  APPLICATION  ROLE  role_id  WITH  (COMMA?  NAME  EQUAL  new_role = role_id)?  (COMMA?  password_setting)?  (COMMA?  default_schema)?
        /// </summary>
        ...
        public override AstRoot VisitIps(TSqlParser.IpsContext context)
        {
            ...
            return new AstIps(context, list);
        }
        ...
        /// 	 : stringtext
        /// </summary>
        public override AstRoot VisitUrl(TSqlParser.UrlContext context)
        {
            List<AstRoot> list = new List<AstRoot>();
            for (IEnumerator enumerator = context.children.GetEnumerator(); enumerator.MoveNext(); 
            )
            ...
            return new AstUrl(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitBackup_priority(TSqlParser.Backup_priorityContext context)
        {
            List<AstRoot> list = new List<AstRoot>();
            for (IEnumerator enumerator = context.children.GetEnumerator(); enumerator.MoveNext(); 
            )
            ...
            return new AstBackupPriority(context, list);
        }
        ...
        /// <summary>
        /// listener_url
        /// 	 : LISTENER_URL  EQUAL  url
        /// </summary>
        public override AstRoot VisitListener_url(TSqlParser.Listener_urlContext context)
        {
            List<AstRoot> list = new List<AstRoot>();
            for (IEnumerator enumerator = context.children.GetEnumerator(); enumerator.MoveNext(); 
            )
            ...
            return new AstListenerUrl(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitPrimary_role(TSqlParser.Primary_roleContext context)
        {
            List<AstRoot> list = new List<AstRoot>();
            for (IEnumerator enumerator = context.children.GetEnumerator(); enumerator.MoveNext(); 
            )
            ...
            return new AstPrimaryRole(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitSecondary_role(TSqlParser.Secondary_roleContext context)
        {
            List<AstRoot> list = new List<AstRoot>();
            for (IEnumerator enumerator = context.children.GetEnumerator(); enumerator.MoveNext(); 
            )
            ...
            return new AstSecondaryRole(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitMaw_process(TSqlParser.Maw_processContext context)
        {
            List<AstRoot> list = new List<AstRoot>();
            for (IEnumerator enumerator = context.children.GetEnumerator(); enumerator.MoveNext(); 
            )
            ...
            return new AstMawProcess(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitMax_memory(TSqlParser.Max_memoryContext context)
        {
            List<AstRoot> list = new List<AstRoot>();
            for (IEnumerator enumerator = context.children.GetEnumerator(); enumerator.MoveNext(); 
            )
            ...
            return new AstMaxMemory(context, list);
        }
        ...
        /// 	 : pwd_settings?  old_pwd_strategies?  (DEFAULT_DATABASE  EQUAL  database_id)?  (DEFAULT_LANGUAGE  EQUAL  language)?  (NAME  EQUAL  login_id)?  (CHECK_POLICY  EQUAL  check_policy = on_off)?  (CHECK_EXPIRATION  EQUAL  check_expiration = on_off)?  (CREDENTIAL  EQUAL  credential_id)?  (NO  CREDENTIAL)?
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitNew_password(TSqlParser.New_passwordContext context)
        {
            List<AstRoot> list = new List<AstRoot>();
            for (IEnumerator enumerator = context.children.GetEnumerator(); enumerator.MoveNext(); 
            )
            ...
            return new AstNewPassword(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitDefault_schema(TSqlParser.Default_schemaContext context)
        {
            List<AstRoot> list = new List<AstRoot>();
            for (IEnumerator enumerator = context.children.GetEnumerator(); enumerator.MoveNext(); 
            )
            ...
            return new AstDefaultSchema(context, list);
        }
