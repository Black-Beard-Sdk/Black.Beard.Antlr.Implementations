#nullable disable
// Generated by Models.ScriptTSqlVisitor.Defaults : vendredi 14 avril 2023
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.Parsers.TSql
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        /// 	 : (PASSWORD  EQUAL  pwd_value  pwd_strategies?)?  (COMMA?  SID  EQUAL  sid = binary_)?  (COMMA?  DEFAULT_DATABASE  EQUAL  database_id)?  (COMMA?  DEFAULT_LANGUAGE  EQUAL  language)?  (COMMA?  CHECK_EXPIRATION  EQUAL  check_expiration = on_off)?  (COMMA?  CHECK_POLICY  EQUAL  check_policy = on_off)?  (COMMA?  CREDENTIAL  EQUAL  credential_id)?
        /// </summary>
        ...
        /// <summary>
        /// create_user_azure_sql_dw
        /// 	 : CREATE  USER  user_id  user_strategy?  (WITH  default_schema)?
        /// 	 | CREATE  USER  user_id  FROM  EXTERNAL  PROVIDER  (WITH  default_schema)?
        /// </summary>
        ...
        /// security_statement
        /// 	 : execute_clause  SEMI?
        /// 	 | GRANT  grant_mode  (ON  (class_type_for_grant  DOUBLE_COLON)?  table = full_table_ref)?  TO  to_principal_rincipal_ids  (WITH  GRANT  OPTION)?  (AS  as_principal = principal_id)?  SEMI?
        ...
        public override AstRoot VisitService_name(TSqlParser.Service_nameContext context)
        {
            ...
            return AstServiceName.Create(context, list);
        }
