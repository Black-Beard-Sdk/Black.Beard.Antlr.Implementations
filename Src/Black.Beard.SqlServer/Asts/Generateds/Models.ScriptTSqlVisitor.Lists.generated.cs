#nullable disable
// Generated by Models.ScriptTSqlVisitor.Lists : vendredi 14 avril 2023
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.Parsers.TSql
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        {
            TSqlParser.Private_keyContext[] source = context.private_key();
            AstPrivateKeys list = new AstPrivateKeys(context, source.Length);
            for (IEnumerator enumerator = source.GetEnumerator(); enumerator.MoveNext(); 
            )
            {
                TSqlParser.Private_keyContext item = ((TSqlParser.Private_keyContext)(enumerator.Current));
