#nullable disable
// Generated by Models.Terminals : vendredi 14 avril 2023
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.Asts.TSql
{
    ...
    public partial class AstBreakStatement : AstRule
    {
        ...
        public AstBreakStatement(ITerminalNode t) : 
                base(t, t.GetText())
        {
        }
        ...
        public AstBreakStatement(ParserRuleContext ctx, string value) : 
                base(ctx, value)
        {
        }
        
        public AstBreakStatement(Position t, string value) : 
                base(t, value)
        {
        }
    ...
    public partial class AstContinueStatement : AstRule
    {
        ...
        public AstContinueStatement(ITerminalNode t) : 
                base(t, t.GetText())
        {
        }
        ...
        public AstContinueStatement(ParserRuleContext ctx, string value) : 
                base(ctx, value)
        {
        }
        
        public AstContinueStatement(Position t, string value) : 
                base(t, value)
        {
        }
