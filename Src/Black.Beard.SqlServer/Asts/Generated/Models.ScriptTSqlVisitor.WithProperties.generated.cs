#nullable disable
// Generated by ScriptClassVisitorWithProperties.cs (Monday, May 8, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Parser
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        /// <summary>
        /// alter_application_role : ALTER  APPLICATION  ROLE  role_id  WITH  (COMMA?  name_role_set)?  (COMMA?  password_setting)?  (COMMA?  default_schema_set)?
        /// </summary>
        ...
        /// <summary>
        /// drop_aggregate : DROP  AGGREGATE  if_exists?  schema_aggregate_ref
        /// </summary>
        ...
        /// <summary>
        /// drop_assembly : DROP  ASSEMBLY  if_exists?  assemblies  with_no_dependents?
        /// </summary>
        ...
        /// <summary>
        /// alter_asymmetric_key : ALTER  ASYMMETRIC  KEY  asym_key_id  (asymmetric_key_option | remove_private_key)
        /// </summary>
        ...
        /// <summary>
        /// drop_asymmetric_key : DROP  ASYMMETRIC  KEY  key_name = id_  remove_provider_key?
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitRead_only_routing_list_set(TSqlParser.Read_only_routing_list_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstReadOnlyRoutingListSet(context, list);
        }
        ...
        /// <summary>
        /// alter_availability_replicat_add : ADD  REPLICA  ON  server_instance_txt  WITH  LR_BRACKET  replicat_options?  RR_BRACKET
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitPrimary_role_mode(TSqlParser.Primary_role_modeContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstPrimaryRoleMode(context, list);
        }
        
        /// <summary>
        /// availability_group_add_item : ag_name = stringtext  WITH  LR_BRACKET  (listener_url_set  COMMA  availability_mode_set  COMMA  failover_mode_manual  COMMA  seeding_mode_set)  RR_BRACKET
        /// </summary>
        public override AstRoot VisitAvailability_group_add_item(TSqlParser.Availability_group_add_itemContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstAvailabilityGroupAddItem(context, list);
        }
        
        /// <summary>
        /// availability_group_update_item : ag_name_modified = stringtext  WITH  LR_BRACKET  availability_group_update_options  RR_BRACKET
        /// </summary>
        public override AstRoot VisitAvailability_group_update_item(TSqlParser.Availability_group_update_itemContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstAvailabilityGroupUpdateItem(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitFailover_mode_set(TSqlParser.Failover_mode_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstFailoverModeSet(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitEndpoint_url_set(TSqlParser.Endpoint_url_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstEndpointUrlSet(context, list);
        }
        ...
        /// <summary>
        /// drop_database : DROP  DATABASE  if_exists?  (COMMA?  database_id)+
        /// </summary>
        ...
        /// <summary>
        /// drop_default : DROP  DEFAULT  if_exists?  (COMMA?  default_ref)
        /// </summary>
        ...
        /// <summary>
        /// drop_db_role : DROP  ROLE  if_exists?  role_id
        /// </summary>
        ...
        /// <summary>
        /// drop_rule : DROP  RULE  if_exists?  (COMMA?  schema_rule_ref)?
        /// </summary>
        ...
        /// <summary>
        /// drop_schema : DROP  SCHEMA  if_exists?  schema_identifier
        /// </summary>
        ...
        /// <summary>
        /// drop_security_policy : DROP  SECURITY  POLICY  if_exists?  schema_security_policy_ref
        /// </summary>
        ...
        /// <summary>
        /// drop_sequence : DROP  SEQUENCE  if_exists?  (COMMA?  database_schema_sequence_ref)?
        /// </summary>
        ...
        /// <summary>
        /// drop_symmetric_key : DROP  SYMMETRIC  KEY  symmetric_key_id  remove_provider_key?
        /// </summary>
        ...
        /// <summary>
        /// drop_synonym : DROP  SYNONYM  if_exists?  schema_synonym_ref
        /// </summary>
        ...
        /// <summary>
        /// drop_user : DROP  USER  if_exists?  user_id
        /// </summary>
        ...
        /// <summary>
        /// create_event_notification : CREATE  EVENT  NOTIFICATION  event_notification_id  ON  event_notification_on  with_fan_in?  FOR  event_type_or_group_ids  TO  SERVICE  broker_name = stringtext  COMMA  broker_service_specifier_or_current_database = stringtext
        /// </summary>
        ...
        /// <summary>
        /// create_or_alter_event_session_with : WITH  LR_BRACKET  event_session_properties  RR_BRACKET
        /// </summary>
        ...
        /// <summary>
        /// alter_fulltext_catalog : ALTER  FULLTEXT  CATALOG  catalog_id  fulltext_catalog_strategy
        /// </summary>
        ...
        /// <summary>
        /// create_fulltext_catalog : CREATE  FULLTEXT  CATALOG  catalog_id  filegroup_set?  in_path_set?  with_accent_sensibility_set?  as_default?  authorization_owner_set?
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitFilegroup_set(TSqlParser.Filegroup_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstFilegroupSet(context, list);
        }
        
        /// <summary>
        /// with_accent_sensibility_set : WITH  ACCENT_SENSITIVITY  EQUAL  on_off
        /// </summary>
        public override AstRoot VisitWith_accent_sensibility_set(TSqlParser.With_accent_sensibility_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstWithAccentSensibilitySet(context, list);
        }
        
        /// <summary>
        /// authorization_owner_set : AUTHORIZATION  owner_id
        /// </summary>
        public override AstRoot VisitAuthorization_owner_set(TSqlParser.Authorization_owner_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstAuthorizationOwnerSet(context, list);
        }
        ...
        /// <summary>
        /// create_fulltext_stoplist : CREATE  FULLTEXT  STOPLIST  stoplist_id  (FROM  (database_stoplist_ref | system_stoplist))?  (AUTHORIZATION  owner_id)?
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitSid_set(TSqlParser.Sid_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstSidSet(context, list);
        }
        
        /// <summary>
        /// default_database_set : DEFAULT_DATABASE  EQUAL  database_id
        /// </summary>
        public override AstRoot VisitDefault_database_set(TSqlParser.Default_database_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDefaultDatabaseSet(context, list);
        }
        
        /// <summary>
        /// check_expiration_set : CHECK_EXPIRATION  EQUAL  on_off
        /// </summary>
        public override AstRoot VisitCheck_expiration_set(TSqlParser.Check_expiration_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstCheckExpirationSet(context, list);
        }
        
        /// <summary>
        /// check_policy_set : CHECK_POLICY  EQUAL  on_off
        /// </summary>
        public override AstRoot VisitCheck_policy_set(TSqlParser.Check_policy_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstCheckPolicySet(context, list);
        }
        
        /// <summary>
        /// credential_set : CREDENTIAL  EQUAL  credential_id
        /// </summary>
        public override AstRoot VisitCredential_set(TSqlParser.Credential_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstCredentialSet(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitName_login_set(TSqlParser.Name_login_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstNameLoginSet(context, list);
        }
        
        /// <summary>
        /// create_login_azure_sql : CREATE  LOGIN  login_id  WITH  password_setting  sid_set?
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitProcess_numanode_set(TSqlParser.Process_numanode_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstProcessNumanodeSet(context, list);
        }
        
        /// <summary>
        /// diagnos_path_set : PATH  EQUAL  string_or_default
        /// </summary>
        public override AstRoot VisitDiagnos_path_set(TSqlParser.Diagnos_path_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDiagnosPathSet(context, list);
        }
        
        /// <summary>
        /// diagnos_max_size_set : MAX_SIZE  EQUAL  size_value
        /// </summary>
        public override AstRoot VisitDiagnos_max_size_set(TSqlParser.Diagnos_max_size_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDiagnosMaxSizeSet(context, list);
        }
        
        /// <summary>
        /// diagnos_max_files_set : MAX_FILES  EQUAL  decimal_default
        /// </summary>
        public override AstRoot VisitDiagnos_max_files_set(TSqlParser.Diagnos_max_files_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDiagnosMaxFilesSet(context, list);
        }
        
        /// <summary>
        /// audit_maxsize : MAXSIZE  EQUAL  decimal_size_unlimited
        /// </summary>
        public override AstRoot VisitAudit_maxsize(TSqlParser.Audit_maxsizeContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstAuditMaxsize(context, list);
        }
        
        /// <summary>
        /// filepath_set : FILEPATH  EQUAL  stringtext
        /// </summary>
        public override AstRoot VisitFilepath_set(TSqlParser.Filepath_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstFilepathSet(context, list);
        }
        
        /// <summary>
        /// max_rollover_files_set : MAX_ROLLOVER_FILES  EQUAL  decimal_unlimited
        /// </summary>
        public override AstRoot VisitMax_rollover_files_set(TSqlParser.Max_rollover_files_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstMaxRolloverFilesSet(context, list);
        }
        
        /// <summary>
        /// max_files_set : MAX_FILES  EQUAL  decimal
        /// </summary>
        public override AstRoot VisitMax_files_set(TSqlParser.Max_files_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstMaxFilesSet(context, list);
        }
        
        /// <summary>
        /// disk_space_set : RESERVE_DISK_SPACE  EQUAL  on_off
        /// </summary>
        public override AstRoot VisitDisk_space_set(TSqlParser.Disk_space_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDiskSpaceSet(context, list);
        }
        
        /// <summary>
        /// name_set : NAME  EQUAL  id_or_string
        /// </summary>
        public override AstRoot VisitName_set(TSqlParser.Name_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstNameSet(context, list);
        }
        
        /// <summary>
        /// maxsize_set : MAXSIZE  EQUAL  max_file_size_value
        /// </summary>
        public override AstRoot VisitMaxsize_set(TSqlParser.Maxsize_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstMaxsizeSet(context, list);
        }
        
        /// <summary>
        /// filegrowth_set : FILEGROWTH  EQUAL  file_size
        /// </summary>
        public override AstRoot VisitFilegrowth_set(TSqlParser.Filegrowth_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstFilegrowthSet(context, list);
        }
        ...
        /// <summary>
        /// merge_statement : with_expression?  MERGE  top_clause?  into_statment  ddl_object  with_table_hints?  as_table_alias?  USING  table_sources  ON  search_condition  when_matches  output_clause?  update_option_clause?  SEMI
        /// </summary>
        ...
        /// <summary>
        /// delete_statement : with_expression?  DELETE  top_clause?  delete_from?  delete_statement_from  with_table_hints?  output_clause?  (FROM  table_sources)?  where_condition_or_current_of?  for_clause?  update_option_clause?
        /// </summary>
        ...
        /// <summary>
        /// insert_statement : with_expression?  INSERT  top_clause?  into_statment?  (ddl_object | rowset_function_limited)  with_table_hints?  (LR_BRACKET  insert_column_name_list  RR_BRACKET)?  output_clause?  insert_statement_value  for_clause?  update_option_clause?
        /// </summary>
        ...
        /// <summary>
        /// update_statement : with_expression?  UPDATE  top_clause?  (ddl_object | rowset_function_limited)  with_table_hints?  SET  update_elems  output_clause?  (FROM  table_sources)?  where_condition_or_current_of?  for_clause?  update_option_clause?
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitDatabase_with_option(TSqlParser.Database_with_optionContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDatabaseWithOption(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitCollate_set(TSqlParser.Collate_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstCollateSet(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitContainment_set(TSqlParser.Containment_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstContainmentSet(context, list);
        }
        ...
        /// <summary>
        /// drop_type : DROP  TYPE  if_exists?  name = schema_type_ref
        /// </summary>
        ...
        /// <summary>
        /// reconfigure_statement : RECONFIGURE  with_override?
        /// </summary>
        ...
        /// <summary>
        /// shutdown_statement : SHUTDOWN  with_nowait?
        /// </summary>
        ...
        /// <summary>
        /// checkpoint_statement : CHECKPOINT  decimal?
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitNot_sub_search_condition(TSqlParser.Not_sub_search_conditionContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstNotSubSearchCondition(context, list);
        }
        ...
        /// <summary>
        /// query_specification : SELECT  allOrDistinct = all_distinct  top = top_clause_with_ties  columns = select_list  (INTO  into = full_table_ref)?  (FROM  from = table_sources)?  where_condition?  (GROUP  BY  ((groupByAll = ALL  groupBys_list) | GROUPING  SETS  LR_BRACKET  groupSet_list  RR_BRACKET))?  (HAVING  having = search_condition)?
        /// </summary>
        ...
        /// <summary>
        /// top_clause_with_ties : TOP  top_expression  with_ties?
        /// </summary>
        public override AstRoot VisitTop_clause_with_ties(TSqlParser.Top_clause_with_tiesContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstTopClauseWithTies(context, list);
        }
        
        /// <summary>
        /// top_clause : TOP  top_expression
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitDb_chaining_set(TSqlParser.Db_chaining_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDbChainingSet(context, list);
        }
        
        /// <summary>
        /// trustworthy_set : TRUSTWORTHY  on_off
        /// </summary>
        public override AstRoot VisitTrustworthy_set(TSqlParser.Trustworthy_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstTrustworthySet(context, list);
        }
        
        /// <summary>
        /// default_language_set : DEFAULT_LANGUAGE  EQUAL  language_setting_value
        /// </summary>
        public override AstRoot VisitDefault_language_set(TSqlParser.Default_language_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDefaultLanguageSet(context, list);
        }
        
        /// <summary>
        /// default_fulltext_language_set : DEFAULT_FULLTEXT_LANGUAGE  EQUAL  language_setting
        /// </summary>
        public override AstRoot VisitDefault_fulltext_language_set(TSqlParser.Default_fulltext_language_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDefaultFulltextLanguageSet(context, list);
        }
        
        /// <summary>
        /// nested_triggers_set : NESTED_TRIGGERS  EQUAL  on_off
        /// </summary>
        public override AstRoot VisitNested_triggers_set(TSqlParser.Nested_triggers_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstNestedTriggersSet(context, list);
        }
        
        /// <summary>
        /// transform_noise_words_set : TRANSFORM_NOISE_WORDS  EQUAL  on_off
        /// </summary>
        public override AstRoot VisitTransform_noise_words_set(TSqlParser.Transform_noise_words_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstTransformNoiseWordsSet(context, list);
        }
        
        /// <summary>
        /// two_digit_year_cutoff_set : TWO_DIGIT_YEAR_CUTOFF  EQUAL  decimal
        /// </summary>
        public override AstRoot VisitTwo_digit_year_cutoff_set(TSqlParser.Two_digit_year_cutoff_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstTwoDigitYearCutoffSet(context, list);
        }
        
        /// <summary>
        /// directory_name_set : DIRECTORY_NAME  EQUAL  stringtext
        /// </summary>
        public override AstRoot VisitDirectory_name_set(TSqlParser.Directory_name_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDirectoryNameSet(context, list);
        }
        
        /// <summary>
        /// non_transacted_access_set : NON_TRANSACTED_ACCESS  EQUAL  off_read_only_full
        /// </summary>
        public override AstRoot VisitNon_transacted_access_set(TSqlParser.Non_transacted_access_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstNonTransactedAccessSet(context, list);
        }
        ...
        /// <summary>
        /// end_conversation : END  CONVERSATION  conversation_handle = local_id  SEMI?  end_conversation_error?
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitError_set(TSqlParser.Error_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstErrorSet(context, list);
        }
        
        /// <summary>
        /// description_set : DESCRIPTION  EQUAL  failure_text = string_local_id
        /// </summary>
        public override AstRoot VisitDescription_set(TSqlParser.Description_setContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstDescriptionSet(context, list);
        }
