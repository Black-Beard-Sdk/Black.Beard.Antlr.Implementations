#nullable disable
// Generated by ScriptClassVisitorWithProperties.cs (Sunday, April 23, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Parser
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        /// <summary>
        /// create_database
        /// 	 : CREATE  DATABASE  database_id  containment_set?  database_on_primary?  database_on_log?  collate?  (WITH  create_database_option_list)?
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitCollate(TSqlParser.CollateContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstCollate(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitNested_triggers(TSqlParser.Nested_triggersContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstNestedTriggers(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitTransform_noise_words(TSqlParser.Transform_noise_wordsContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstTransformNoiseWords(context, list);
        }
        ...
        /// </summary>
        public override AstRoot VisitTwo_digit_year_cutoff(TSqlParser.Two_digit_year_cutoffContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstTwoDigitYearCutoff(context, list);
        }
        ...
        /// 	 : EQUAL  NON_TRANSACTED_ACCESS  EQUAL  off_read_only_full
        /// </summary>
        ...
        /// <summary>
        /// file_spec
        /// 	 : LR_BRACKET  name_set  COMMA?  filename_set  COMMA?  (size_set  COMMA?)?  (maxsize_set  COMMA?)?  (filegrowth  COMMA?)?  RR_BRACKET
        /// </summary>
        ...
        /// </summary>
        public override AstRoot VisitFilegrowth(TSqlParser.FilegrowthContext context)
        {
            AstRootList<AstRoot> list = this.GetList(context);
            return new AstFilegrowth(context, list);
        }
