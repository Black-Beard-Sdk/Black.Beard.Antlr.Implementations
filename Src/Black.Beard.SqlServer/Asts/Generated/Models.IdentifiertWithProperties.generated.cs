#nullable disable
// Generated by ScriptClassIdentifiertWithProperties.cs (Monday, May 8, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Asts
{
    ...
    public partial class AstDropStatistics : AstBnfRule
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            writer.Append(Constants.STATISTICS);
            writer.ToString(_fullTableRefColumns);
            return true;
        }
    ...
    public partial class AstFullTableRefColumn : AstBnfRule
    {
                ...
                base(p)
        {
            ...
            )
            {
                ...
                {
                    this._name = ((AstId)(enumerator.Current));
                }
            }
        }
        
        public AstFullTableRefColumn(Position p, AstFullTableRef fullTableRef, AstId name) : 
                base(p)
        {
        ...
        {
            writer.EnsureEndBy(' ');
            bool test = (_fullTableRef != null);
            if (test)
            {
                writer.ToString(_fullTableRef);
                writer.Append(Constants.DOT);
            }
            writer.ToString(_name);
            return true;
        }
    ...
    public partial class AstPartitionFunction : AstBnfRule
    {
        ...
        {
            writer.EnsureEndBy(' ');
            bool test = (_databaseId != null);
            if (test)
            {
                writer.ToString(_databaseId);
                writer.Append(Constants.DOT);
            }
            writer.Append(Constants.DOLLAR_PARTITION);
            writer.Append(Constants.DOT);
            writer.ToString(_functionId);
            writer.Append(Constants.LR_BRACKET);
            writer.ToString(_expression);
    ...
    public partial class AstServerDatabaseSchemaObjectRef : AstBnfRule
    {
        ...
        {
            writer.EnsureEndBy(' ');
            bool test = (_serverId != null);
            if (test)
            {
                writer.ToString(_serverId);
                writer.Append(Constants.DOT);
            }
            bool test1 = (_databaseId != null);
            if (test1)
            {
                writer.ToString(_databaseId);
                writer.Append(Constants.DOT);
            }
            bool test2 = (_schemaIdentifier != null);
            if (test2)
            {
                writer.ToString(_schemaIdentifier);
                writer.Append(Constants.DOT);
            }
            writer.ToString(_objectIdentifier);
            return true;
        }
    ...
    public partial class AstEventModulePackageActionRef : AstBnfRule
    {
        ...
        {
            writer.EnsureEndBy(' ');
            bool test = (_eventModuleGuidId != null);
            if (test)
            {
                writer.ToString(_eventModuleGuidId);
                writer.Append(Constants.DOT);
            }
            writer.ToString(_eventPackageId);
            writer.Append(Constants.DOT);
            writer.ToString(_actionId);
            return true;
        }
    ...
    public partial class AstSchemaSequenceRef : AstBnfRule
    {
        ...
        {
            writer.EnsureEndBy(' ');
            bool test = (_schemaIdentifier != null);
            if (test)
            {
                writer.ToString(_schemaIdentifier);
                writer.Append(Constants.DOT);
            }
            writer.ToString(_sequenceId);
            return true;
        }
    ...
    public partial class AstDatabaseSchemaSequenceRef : AstBnfRule
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            writer.ToString(_schemaSequenceRef);
            return true;
        }
    ...
    public partial class AstSchemaObjectStatisticsRef : AstBnfRule
    {
        ...
        {
            writer.EnsureEndBy(' ');
            writer.ToString(_schemaObjectRef);
            writer.Append(Constants.DOT);
            writer.ToString(_statisticsId);
            return true;
        }
    ...
    public partial class AstSchemaSqlIdentifierId : AstBnfRule
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            writer.ToString(_sqlIdentifierId);
            return true;
        }
    ...
    public partial class AstSchemaSecurityPolicyRef : AstBnfRule
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            writer.ToString(_securityPolicyId);
            return true;
        }
    ...
    public partial class AstDatabaseSchemaQueueRef : AstBnfRule
    {
        ...
        {
            writer.EnsureEndBy(' ');
            bool test = (_databaseSchemaRef != null);
            if (test)
            {
                writer.ToString(_databaseSchemaRef);
                writer.Append(Constants.DOT);
            }
            writer.ToString(_queueId);
            return true;
    ...
    public partial class AstDropBackwardCompatibleIndex : AstBnfRule
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            writer.ToString(_tableOrViewId);
            writer.Append(Constants.DOT);
            writer.ToString(_indexId);
            return true;
        }
    ...
    public partial class AstFullTableRef : AstBnfRule
    {
        ...
        private static string _ruleValue = "database_schema_table_ref | database_schema_ref?  blocking_hierarchy = BLOCKING_H" +
            "IERARCHY";
        ...
        {
            writer.EnsureEndBy(' ');
            writer.ToString(_databaseSchemaTableRef);
            writer.ToString(_databaseSchemaRef);
            writer.Append(Constants.BLOCKING_HIERARCHY);
            return true;
        }
    ...
    public partial class AstEntityNameForAzureDwRef : AstBnfRule
    {
        ...
        private static string _ruleValue = "schema_identifier | schema_identifier  DOT  object_identifier";
    ...
    public partial class AstFuncProcNameDatabaseSchemaRef : AstBnfRule
    {
        ...
        private static string _ruleValue = "database_schema_function_ref | schema_func_proc_ref";
        ...
        {
            writer.EnsureEndBy(' ');
            writer.ToString(_databaseSchemaFunctionRef);
            writer.ToString(_schemaFuncProcRef);
            return true;
        }
    ...
    public partial class AstFullColumnRef : AstBnfRule
    {
        ...
        private static string _ruleValue = "server_id?  DOT  schema_identifier?  DOT  table_id?  DOT  column_id | schema_iden" +
            "tifier?  DOT  table_id?  DOT  column_id | table_id?  DOT  column_id | column_id";
    ...
    public partial class AstFullPredicateSourceRef : AstBnfRule
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            writer.ToString(_eventPackageId);
            writer.Append(Constants.DOT);
            writer.ToString(_predicateSourceId);
            return true;
        }
    ...
    public partial class AstAssemblyClassMethodRef : AstBnfRule
    {
        ...
        {
            writer.EnsureEndBy(' ');
            writer.ToString(_assemblyId);
            writer.Append(Constants.DOT);
            writer.ToString(_classId);
            writer.Append(Constants.DOT);
            writer.ToString(_methodId);
            return true;
        }
