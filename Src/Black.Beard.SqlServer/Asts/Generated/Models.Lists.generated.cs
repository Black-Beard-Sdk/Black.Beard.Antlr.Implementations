#nullable disable
// Generated by ScriptClassLists.cs (Monday, May 8, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Asts
{
    ...
    public partial class AstBatchs : AstRuleList<AstBatch>
    {
        ...
        private static string _ruleValue = "batch  (SEMI+  batch)*";
    ...
    public partial class AstIps : AstRuleList<AstIpListenerComma>
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            if ((this.Count > 0))
            {
                ...
                writer.ToString(this[index]);
                writer.Append(Constants.RR_BRACKET);
                if ((this.Count > 1))
                {
                    for (index = 1; (index < this.Count); index++)
                    {
    ...
    /// </summary>
    public partial class AstReplicatOptions : AstRuleList<AstReplicatOption>
    {
        
        private static string _ruleValue = "replicat_option  (COMMA  replicat_option)*";
        
        private static string _ruleName = "replicat_options";
        
        public AstReplicatOptions(params AstReplicatOption[] items) : 
                base(Position.Default, items)
        {
        }
        
        public AstReplicatOptions(Position position, params AstReplicatOption[] items) : 
                base(position, items)
        {
        }
        
        public AstReplicatOptions(ParserRuleContext ctx, params AstReplicatOption[] items) : 
                base(ctx, items)
        {
        }
        
        public AstReplicatOptions(ParserRuleContext ctx, int capacity) : 
                base(ctx, capacity)
        {
        }
        ...
        public override void Accept(IAstTSqlVisitor visitor)
        {
            visitor.VisitReplicatOptions(this);
        }
        
        /// <summary>
        /// replicat_options : replicat_option  (COMMA  replicat_option)*
        /// </summary>
        public static AstReplicatOptions New(ParserRuleContext ctx, params AstReplicatOption[] items)
        {
            return new AstReplicatOptions(ctx, items);
        }
        
        /// <summary>
        /// replicat_options : replicat_option  (COMMA  replicat_option)*
        /// </summary>
        public static AstReplicatOptions New(Position position, params AstReplicatOption[] items)
        {
            return new AstReplicatOptions(position, items);
        }
        
        /// <summary>
        /// replicat_options : replicat_option  (COMMA  replicat_option)*
        /// </summary>
        public static AstReplicatOptions New(params AstReplicatOption[] items)
        {
            return new AstReplicatOptions(Position.Default, items);
        }
        
        public static AstReplicatOptions? Null()
        {
            return null;
        }
    ...
    /// </summary>
    public partial class AstAvailabilityGroupAddItems : AstRuleList<AstAvailabilityGroupAddItem>
    {
        
        private static string _ruleValue = "availability_group_add_item  (COMMA  availability_group_add_item)*";
        
        private static string _ruleName = "availability_group_add_items";
        
        public AstAvailabilityGroupAddItems(params AstAvailabilityGroupAddItem[] items) : 
                base(Position.Default, items)
        {
        }
        
        public AstAvailabilityGroupAddItems(Position position, params AstAvailabilityGroupAddItem[] items) : 
                base(position, items)
        {
        }
        
        public AstAvailabilityGroupAddItems(ParserRuleContext ctx, params AstAvailabilityGroupAddItem[] items) : 
                base(ctx, items)
        {
        }
        
        public AstAvailabilityGroupAddItems(ParserRuleContext ctx, int capacity) : 
                base(ctx, capacity)
        {
        }
        ...
        public override void Accept(IAstTSqlVisitor visitor)
        {
            visitor.VisitAvailabilityGroupAddItems(this);
        }
        
        /// <summary>
        /// availability_group_add_items : availability_group_add_item  (COMMA  availability_group_add_item)*
        /// </summary>
        public static AstAvailabilityGroupAddItems New(ParserRuleContext ctx, params AstAvailabilityGroupAddItem[] items)
        {
            return new AstAvailabilityGroupAddItems(ctx, items);
        }
        
        /// <summary>
        /// availability_group_add_items : availability_group_add_item  (COMMA  availability_group_add_item)*
        /// </summary>
        public static AstAvailabilityGroupAddItems New(Position position, params AstAvailabilityGroupAddItem[] items)
        {
            return new AstAvailabilityGroupAddItems(position, items);
        }
        
        /// <summary>
        /// availability_group_add_items : availability_group_add_item  (COMMA  availability_group_add_item)*
        /// </summary>
        public static AstAvailabilityGroupAddItems New(params AstAvailabilityGroupAddItem[] items)
        {
            return new AstAvailabilityGroupAddItems(Position.Default, items);
        }
        
        public static AstAvailabilityGroupAddItems? Null()
        {
            return null;
        }
    ...
    /// </summary>
    public partial class AstAvailabilityGroupUpdateItems : AstRuleList<AstAvailabilityGroupUpdateItem>
    {
        
        private static string _ruleValue = "availability_group_update_item  (COMMA  availability_group_update_item)*";
        
        private static string _ruleName = "availability_group_update_items";
        
        public AstAvailabilityGroupUpdateItems(params AstAvailabilityGroupUpdateItem[] items) : 
                base(Position.Default, items)
        {
        }
        
        public AstAvailabilityGroupUpdateItems(Position position, params AstAvailabilityGroupUpdateItem[] items) : 
                base(position, items)
        {
        }
        
        public AstAvailabilityGroupUpdateItems(ParserRuleContext ctx, params AstAvailabilityGroupUpdateItem[] items) : 
                base(ctx, items)
        {
        }
        
        public AstAvailabilityGroupUpdateItems(ParserRuleContext ctx, int capacity) : 
                base(ctx, capacity)
        {
        }
        ...
        public override void Accept(IAstTSqlVisitor visitor)
        {
            visitor.VisitAvailabilityGroupUpdateItems(this);
        }
        
        /// <summary>
        /// availability_group_update_items : availability_group_update_item  (COMMA  availability_group_update_item)*
        /// </summary>
        public static AstAvailabilityGroupUpdateItems New(ParserRuleContext ctx, params AstAvailabilityGroupUpdateItem[] items)
        {
            return new AstAvailabilityGroupUpdateItems(ctx, items);
        }
        
        /// <summary>
        /// availability_group_update_items : availability_group_update_item  (COMMA  availability_group_update_item)*
        /// </summary>
        public static AstAvailabilityGroupUpdateItems New(Position position, params AstAvailabilityGroupUpdateItem[] items)
        {
            return new AstAvailabilityGroupUpdateItems(position, items);
        }
        
        /// <summary>
        /// availability_group_update_items : availability_group_update_item  (COMMA  availability_group_update_item)*
        /// </summary>
        public static AstAvailabilityGroupUpdateItems New(params AstAvailabilityGroupUpdateItem[] items)
        {
            return new AstAvailabilityGroupUpdateItems(Position.Default, items);
        }
        
        public static AstAvailabilityGroupUpdateItems? Null()
        {
            return null;
        }
    ...
    /// </summary>
    public partial class AstAvailabilityGroupUpdateOptions : AstRuleList<AstListenerUrlSet>
    {
        
        private static string _ruleValue = "listener_url_set  (COMMA  availability_group_option)*";
        
        private static string _ruleName = "availability_group_update_options";
        
        public AstAvailabilityGroupUpdateOptions(params AstListenerUrlSet[] items) : 
                base(Position.Default, items)
        {
        }
        
        public AstAvailabilityGroupUpdateOptions(Position position, params AstListenerUrlSet[] items) : 
                base(position, items)
        {
        }
        
        public AstAvailabilityGroupUpdateOptions(ParserRuleContext ctx, params AstListenerUrlSet[] items) : 
                base(ctx, items)
        {
        }
        
        public AstAvailabilityGroupUpdateOptions(ParserRuleContext ctx, int capacity) : 
                base(ctx, capacity)
        {
        }
        ...
        public override void Accept(IAstTSqlVisitor visitor)
        {
            visitor.VisitAvailabilityGroupUpdateOptions(this);
        }
        
        /// <summary>
        /// availability_group_update_options : listener_url_set  (COMMA  availability_group_option)*
        /// </summary>
        public static AstAvailabilityGroupUpdateOptions New(ParserRuleContext ctx, params AstListenerUrlSet[] items)
        {
            return new AstAvailabilityGroupUpdateOptions(ctx, items);
        }
        
        /// <summary>
        /// availability_group_update_options : listener_url_set  (COMMA  availability_group_option)*
        /// </summary>
        public static AstAvailabilityGroupUpdateOptions New(Position position, params AstListenerUrlSet[] items)
        {
            return new AstAvailabilityGroupUpdateOptions(position, items);
        }
        
        /// <summary>
        /// availability_group_update_options : listener_url_set  (COMMA  availability_group_option)*
        /// </summary>
        public static AstAvailabilityGroupUpdateOptions New(params AstListenerUrlSet[] items)
        {
            return new AstAvailabilityGroupUpdateOptions(Position.Default, items);
        }
        
        public static AstAvailabilityGroupUpdateOptions? Null()
        {
            return null;
        }
    ...
    /// </summary>
    public partial class AstEventTypeOrGroupIds : AstRuleList<AstEventTypeOrGroupId>
    {
        
        private static string _ruleValue = "event_type_or_group_id  (COMMA  event_type_or_group_id)*";
        
        private static string _ruleName = "event_type_or_group_ids";
        
        public AstEventTypeOrGroupIds(params AstEventTypeOrGroupId[] items) : 
                base(Position.Default, items)
        {
        }
        
        public AstEventTypeOrGroupIds(Position position, params AstEventTypeOrGroupId[] items) : 
                base(position, items)
        {
        }
        
        public AstEventTypeOrGroupIds(ParserRuleContext ctx, params AstEventTypeOrGroupId[] items) : 
                base(ctx, items)
        {
        }
        
        public AstEventTypeOrGroupIds(ParserRuleContext ctx, int capacity) : 
                base(ctx, capacity)
        {
        }
        ...
        public override void Accept(IAstTSqlVisitor visitor)
        {
            visitor.VisitEventTypeOrGroupIds(this);
        }
        
        /// <summary>
        /// event_type_or_group_ids : event_type_or_group_id  (COMMA  event_type_or_group_id)*
        /// </summary>
        public static AstEventTypeOrGroupIds New(ParserRuleContext ctx, params AstEventTypeOrGroupId[] items)
        {
            return new AstEventTypeOrGroupIds(ctx, items);
        }
        
        /// <summary>
        /// event_type_or_group_ids : event_type_or_group_id  (COMMA  event_type_or_group_id)*
        /// </summary>
        public static AstEventTypeOrGroupIds New(Position position, params AstEventTypeOrGroupId[] items)
        {
            return new AstEventTypeOrGroupIds(position, items);
        }
        
        /// <summary>
        /// event_type_or_group_ids : event_type_or_group_id  (COMMA  event_type_or_group_id)*
        /// </summary>
        public static AstEventTypeOrGroupIds New(params AstEventTypeOrGroupId[] items)
        {
            return new AstEventTypeOrGroupIds(Position.Default, items);
        }
        
        public static AstEventTypeOrGroupIds? Null()
        {
            return null;
        }
    ...
    /// </summary>
    public partial class AstEventSessionProperties : AstRuleList<AstEventSessionProperty>
    {
        
        private static string _ruleValue = "event_session_property  (COMMA  event_session_property)*";
        
        private static string _ruleName = "event_session_properties";
        
        public AstEventSessionProperties(params AstEventSessionProperty[] items) : 
                base(Position.Default, items)
        {
        }
        
        public AstEventSessionProperties(Position position, params AstEventSessionProperty[] items) : 
                base(position, items)
        {
        }
        
        public AstEventSessionProperties(ParserRuleContext ctx, params AstEventSessionProperty[] items) : 
                base(ctx, items)
        {
        }
        
        public AstEventSessionProperties(ParserRuleContext ctx, int capacity) : 
                base(ctx, capacity)
        {
        }
        ...
        public override void Accept(IAstTSqlVisitor visitor)
        {
            visitor.VisitEventSessionProperties(this);
        }
        
        /// <summary>
        /// event_session_properties : event_session_property  (COMMA  event_session_property)*
        /// </summary>
        public static AstEventSessionProperties New(ParserRuleContext ctx, params AstEventSessionProperty[] items)
        {
            return new AstEventSessionProperties(ctx, items);
        }
        
        /// <summary>
        /// event_session_properties : event_session_property  (COMMA  event_session_property)*
        /// </summary>
        public static AstEventSessionProperties New(Position position, params AstEventSessionProperty[] items)
        {
            return new AstEventSessionProperties(position, items);
        }
        
        /// <summary>
        /// event_session_properties : event_session_property  (COMMA  event_session_property)*
        /// </summary>
        public static AstEventSessionProperties New(params AstEventSessionProperty[] items)
        {
            return new AstEventSessionProperties(Position.Default, items);
        }
        
        public static AstEventSessionProperties? Null()
        {
            return null;
        }
    ...
    /// </summary>
    public partial class AstAlterLoginSqlServerSettings : AstRuleList<AstAlterLoginSqlServerSetting>
    {
        
        private static string _ruleValue = "alter_login_sql_server_setting  (COMMA  alter_login_sql_server_setting)*";
        
        private static string _ruleName = "alter_login_sql_server_settings";
        
        public AstAlterLoginSqlServerSettings(params AstAlterLoginSqlServerSetting[] items) : 
                base(Position.Default, items)
        {
        }
        
        public AstAlterLoginSqlServerSettings(Position position, params AstAlterLoginSqlServerSetting[] items) : 
                base(position, items)
        {
        }
        
        public AstAlterLoginSqlServerSettings(ParserRuleContext ctx, params AstAlterLoginSqlServerSetting[] items) : 
                base(ctx, items)
        {
        }
        
        public AstAlterLoginSqlServerSettings(ParserRuleContext ctx, int capacity) : 
                base(ctx, capacity)
        {
        }
        ...
        /// alter_login_sql_server_settings : alter_login_sql_server_setting  (COMMA  alter_login_sql_server_setting)*
        /// </summary>
        public static AstAlterLoginSqlServerSettings New(ParserRuleContext ctx, params AstAlterLoginSqlServerSetting[] items)
        {
            return new AstAlterLoginSqlServerSettings(ctx, items);
        }
        
        /// <summary>
        /// alter_login_sql_server_settings : alter_login_sql_server_setting  (COMMA  alter_login_sql_server_setting)*
        /// </summary>
        public static AstAlterLoginSqlServerSettings New(Position position, params AstAlterLoginSqlServerSetting[] items)
        {
            return new AstAlterLoginSqlServerSettings(position, items);
        }
        
        /// <summary>
        /// alter_login_sql_server_settings : alter_login_sql_server_setting  (COMMA  alter_login_sql_server_setting)*
        /// </summary>
        public static AstAlterLoginSqlServerSettings New(params AstAlterLoginSqlServerSetting[] items)
        {
            return new AstAlterLoginSqlServerSettings(Position.Default, items);
        }
    ...
    public partial class AstOnPartitions : AstRuleList<AstPartitionNums>
    {
        ...
        private static string _ruleValue = "ON  PARTITIONS  LR_BRACKET  partition_nums  (COMMA  partition_nums)*  RR_BRACKET";
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            {
                int index = 0;
                writer.Append(Constants.ON);
                writer.Append(Constants.PARTITIONS);
                writer.Append(Constants.LR_BRACKET);
                writer.ToString(this[index]);
                if ((this.Count > 1))
                {
    ...
    /// </summary>
    public partial class AstFilespec : AstRuleList<AstNameSet>
    {
        
        private static string _ruleValue = "LR_BRACKET  name_set  (COMMA  newname_set)?  (COMMA  filename_set)?  (COMMA  size" +
            "_set)?  (COMMA  maxsize_set)?  (COMMA  filegrowth_set)?  (COMMA  OFFLINE)?  RR_B" +
            "RACKET";
        
        private static string _ruleName = "filespec";
        
        public AstFilespec(params AstNameSet[] items) : 
                base(Position.Default, items)
        {
        }
        
        public AstFilespec(Position position, params AstNameSet[] items) : 
                base(position, items)
        {
        }
        
        public AstFilespec(ParserRuleContext ctx, params AstNameSet[] items) : 
                base(ctx, items)
        {
        }
        ...
        /// filespec : LR_BRACKET  name_set  (COMMA  newname_set)?  (COMMA  filename_set)?  (COMMA  size_set)?  (COMMA  maxsize_set)?  (COMMA  filegrowth_set)?  (COMMA  OFFLINE)?  RR_BRACKET
        /// </summary>
        public static AstFilespec New(ParserRuleContext ctx, params AstNameSet[] items)
        {
        ...
        /// filespec : LR_BRACKET  name_set  (COMMA  newname_set)?  (COMMA  filename_set)?  (COMMA  size_set)?  (COMMA  maxsize_set)?  (COMMA  filegrowth_set)?  (COMMA  OFFLINE)?  RR_BRACKET
        /// </summary>
        public static AstFilespec New(Position position, params AstNameSet[] items)
        {
        ...
        /// filespec : LR_BRACKET  name_set  (COMMA  newname_set)?  (COMMA  filename_set)?  (COMMA  size_set)?  (COMMA  maxsize_set)?  (COMMA  filegrowth_set)?  (COMMA  OFFLINE)?  RR_BRACKET
        /// </summary>
        public static AstFilespec New(params AstNameSet[] items)
        {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            if ((this.Count > 0))
            {
                ...
                {
                    writer.Append(Constants.COMMA);
                    writer.Append(Constants.OFFLINE);
                }
                writer.Append(Constants.RR_BRACKET);
            }
            return true;
    ...
    public partial class AstOrderByClause : AstRuleList<AstOrderByExpression>
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            {
                int index = 0;
                writer.Append(Constants.ORDER);
                writer.Append(Constants.BY);
                writer.ToString(this[index]);
                if ((this.Count > 1))
                {
                    for (index = 1; (index < this.Count); index++)
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            if ((this.Count > 0))
            {
                ...
                if ((this.Count > 1))
                {
                    for (index = 1; (index < this.Count); index++)
                    {
                        writer.Append(Constants.UNION);
                        writer.Append(Constants.ALL);
                        writer.ToString(this[index]);
                    }
                }
            }
    ...
    public partial class AstTableValueConstructor : AstRuleList<AstExpressionList>
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            {
                int index = 0;
                writer.Append(Constants.VALUES);
                writer.Append(Constants.LR_BRACKET);
                writer.ToString(this[index]);
                writer.Append(Constants.RR_BRACKET);
                if ((this.Count > 1))
    ...
    public partial class AstExpressionLanguage : AstRuleList<AstExpression>
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            if ((this.Count > 0))
            {
                ...
                {
                    writer.Append(Constants.COMMA);
                    writer.Append(Constants.LANGUAGE);
                    writer.ToString(this[index]);
                }
            }
            return true;
    ...
    public partial class AstUpdateOptionClause : AstRuleList<AstUpdateOption>
    {
        ...
        public override bool ToString(Writer writer, StrategySerializationItem strategy)
        {
            ...
            {
                int index = 0;
                writer.Append(Constants.OPTION);
                writer.Append(Constants.LR_BRACKET);
                writer.ToString(this[index]);
                if ((this.Count > 1))
                {
