#nullable disable
// Generated by ScriptClassLists.cs (Wednesday, April 19, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
";
    ...
    public partial class AstDatabaseFileSpecList : AstRuleList<AstDatabaseFileSpec>
    {
        ...
        public AstDatabaseFileSpecList(params AstDatabaseFileSpec[] items) : 
                base(Position.Default, items)
        {
        }
        
        public AstDatabaseFileSpecList(Position position, params AstDatabaseFileSpec[] items) : 
                base(position, items)
        {
        }
        
        public AstDatabaseFileSpecList(ParserRuleContext ctx, params AstDatabaseFileSpec[] items) : 
                base(ctx, items)
        {
        }
        ...
        /// 	 : database_file_spec  (COMMA  database_file_spec)*
        /// </summary>
        public static AstDatabaseFileSpecList New(ParserRuleContext ctx, params AstDatabaseFileSpec[] items)
        {
            return new AstDatabaseFileSpecList(ctx, items);
        }
        ...
        /// 	 : database_file_spec  (COMMA  database_file_spec)*
        /// </summary>
        public static AstDatabaseFileSpecList New(Position position, params AstDatabaseFileSpec[] items)
        {
            return new AstDatabaseFileSpecList(position, items);
        }
        ...
        /// 	 : database_file_spec  (COMMA  database_file_spec)*
        /// </summary>
        public static AstDatabaseFileSpecList New(params AstDatabaseFileSpec[] items)
        {
            return new AstDatabaseFileSpecList(Position.Default, items);
        }
        
        public static AstDatabaseFileSpecList Null()
        {
            return null;
        }
    }
