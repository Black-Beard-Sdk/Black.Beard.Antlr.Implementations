#nullable disable
// Generated by ScriptClassVisitorEnums.cs (Sunday, April 30, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Parser
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        /// <summary>
        /// class_type_for_sql_database : OBJECT | ASSEMBLY | ASYMMETRIC  KEY | CERTIFICATE | TYPE | DATABASE | FULLTEXT  CATALOG | FULLTEXT  STOPLIST | ROLE | SCHEMA | SEARCH  PROPERTY  LIST | SYMMETRIC  KEY | XML  SCHEMA  COLLECTION
        /// </summary>
        ...
        /// <summary>
        /// enum_dml : SELECT | INSERT | DELETE | UPDATE
        /// </summary>
        ...
        /// <summary>
        /// index_status_enum : DISABLE | PAUSE | ABORT
        /// </summary>
        ...
        /// <summary>
        /// filegroup_updatability_option : READONLY | READWRITE | READ_ONLY | READ_WRITE
        /// </summary>
        ...
        /// <summary>
        /// sybase_legacy_hint : HOLDLOCK | NOHOLDLOCK | READPAST | SHARED
        /// </summary>
        ...
        /// <summary>
        /// object_type_for_grant : APPLICATION  ROLE | ASSEMBLY | ASYMMETRIC  KEY | AUDIT | AVAILABILITY  GROUP | BROKER  PRIORITY | CERTIFICATE | CONTRACT | CREDENTIAL | CRYPTOGRAPHIC  PROVIDER | DATABASE  (AUDIT  SPECIFICATION | ENCRYPTION  KEY | EVENT  SESSION | SCOPED  (CONFIGURATION | CREDENTIAL | RESOURCE  GOVERNOR))? | ENDPOINT | EVENT  SESSION | EXTERNAL  (DATA  SOURCE | FILE  FORMAT | LIBRARY | RESOURCE  POOL | TABLE | CATALOG | STOPLIST) | LOGIN | MASTER  KEY | MESSAGE  TYPE | OBJECT | PARTITION  (FUNCTION | SCHEME) | REMOTE  SERVICE  BINDING | RESOURCE  GOVERNOR | ROLE | ROUTE | SCHEMA | SEARCH  PROPERTY  LIST | SERVER  ((AUDIT  SPECIFICATION?) | ROLE)? | SERVICE | SQL  LOGIN | SYMMETRIC  KEY | TRIGGER  (DATABASE | SERVER) | TYPE | USER | XML  SCHEMA  COLLECTION
        /// </summary>
        ...
        /// <summary>
        /// file_size_unity : KB | MB | GB | TB | MODULE
        /// </summary>
        ...
        /// <summary>
        /// session_mode : ALLOW_SINGLE_EVENT_LOSS | ALLOW_MULTIPLE_EVENT_LOSS | NO_EVENT_LOSS
        /// </summary>
        ...
        /// <summary>
        /// function_option_enum : ENCRYPTION | SCHEMABINDING | RETURNS  NULL_  ON  NULL_  INPUT | CALLED  ON  NULL_  INPUT
        /// </summary>
        ...
        /// <summary>
        /// procedure_option_enum : ENCRYPTION | RECOMPILE
        /// </summary>
        ...
        /// <summary>
        /// partner_option_enum : FAILOVER | FORCE_SERVICE_ALLOW_DATA_LOSS | OFF | RESUME | SAFETY  (FULL | OFF) | SUSPEND
        /// </summary>
        ...
        /// <summary>
        /// recovery_option_enum : RECOVERY  (FULL | BULK_LOGGED | SIMPLE) | PAGE_VERIFY  (CHECKSUM | TORN_PAGE_DETECTION | NONE)
        /// </summary>
        ...
        /// <summary>
        /// column_modifier_enum : ROWGUIDCOL | PERSISTED | NOT  FOR  REPLICATION | SPARSE | HIDDEN_KEYWORD
        /// </summary>
        ...
        /// <summary>
        /// declare_set_cursor_common_partial_enum : (FORWARD_ONLY | SCROLL) | (STATIC | KEYSET | DYNAMIC | FAST_FORWARD) | (READ_ONLY | SCROLL_LOCKS | OPTIMISTIC) | TYPE_WARNING
        /// </summary>
        ...
        /// <summary>
        /// absolute_relative : ABSOLUTE | RELATIVE
        /// </summary>
        ...
        /// <summary>
        /// fetch_cursor_strategy : NEXT | PRIOR | FIRST | LAST
        /// </summary>
        ...
        /// <summary>
        /// transaction_isolation : READ  UNCOMMITTED | READ  COMMITTED | REPEATABLE  READ | SNAPSHOT | SERIALIZABLE
        /// </summary>
        ...
        /// <summary>
        /// expression_operator : STAR | DIVIDE | MODULE | PLUS | MINUS | BIT_AND | BIT_XOR | BIT_OR | DOUBLE_BAR
        /// </summary>
        ...
        /// <summary>
        /// message_validation_value_enum : NONE | EMPTY | WELL_FORMED_XML
        /// </summary>
        ...
        /// <summary>
        /// audit_operator : EQUAL | LESS  GREATER | EXCLAMATION  EQUAL | GREATER | GREATER  EQUAL | LESS | LESS  EQUAL
        /// </summary>
        ...
        /// <summary>
        /// statistic_value : OFF | ON  (INCREMENTAL  EQUAL  ON | OFF)
        /// </summary>
        ...
        /// <summary>
        /// algorithm_short : AES_128 | AES_192 | AES_256 | TRIPLE_DES_3KEY
        /// </summary>
        ...
        /// <summary>
        /// grant_permission_enum : ADMINISTER  (BULK  OPERATIONS | DATABASE  BULK  OPERATIONS) | AUTHENTICATE  SERVER? | BACKUP  (DATABASE | LOG) | CHECKPOINT | CONNECT  (ANY  DATABASE | REPLICATION | SQL)? | CONTROL  SERVER? | DELETE | EXECUTE  (ANY  EXTERNAL  SCRIPT)? | EXTERNAL  ACCESS  ASSEMBLY | IMPERSONATE  (ANY  LOGIN)? | INSERT | KILL  DATABASE  CONNECTION | RECEIVE | REFERENCES | SELECT  (ALL  USER  SECURABLES)? | SEND | SHOWPLAN | SHUTDOWN | SUBSCRIBE  QUERY  NOTIFICATIONS | TAKE  OWNERSHIP | UNMASK | UNSAFE  ASSEMBLY | UPDATE | VIEW  (ANY  (DATABASE | DEFINITION | COLUMN  (ENCRYPTION | MASTER)  KEY  DEFINITION) | CHANGE  TRACKING | DATABASE  STATE | DEFINITION | SERVER  STATE)
        /// </summary>
        ...
        /// <summary>
        /// sensitive : SEMI_SENSITIVE | INSENSITIVE
        /// </summary>
        ...
        /// <summary>
        /// update_option_enum : (HASH | ORDER)  GROUP | (MERGE | HASH | CONCAT)  UNION | (LOOP | MERGE | HASH)  JOIN | EXPAND  VIEWS | FORCE  ORDER | IGNORE_NONCLUSTERED_COLUMNSTORE_INDEX | KEEP  PLAN | KEEPFIXED  PLAN | OPTIMIZE  FOR  UNKNOWN | PARAMETERIZATION  (SIMPLE | FORCED) | RECOMPILE | ROBUST  PLAN
        /// </summary>
        ...
        /// <summary>
        /// scalar_function_name_enum : RIGHT | LEFT | BINARY_CHECKSUM | CHECKSUM
        /// </summary>
