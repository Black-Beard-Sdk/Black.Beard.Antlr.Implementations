#nullable disable
// Generated by ScriptClassVisitorList.cs (Monday, May 8, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Parser
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        /// </summary>
        public override AstRoot VisitReplicat_options(TSqlParser.Replicat_optionsContext context)
        {
            TSqlParser.Replicat_optionContext[] source = context.replicat_option();
            AstReplicatOptions list = new AstReplicatOptions(context, source.Length);
            for (var enumerator = source.GetEnumerator(); enumerator.MoveNext(); 
            )
            {
                TSqlParser.Replicat_optionContext item = ((TSqlParser.Replicat_optionContext)(enumerator.Current));
                AstReplicatOption acceptResult = ((AstReplicatOption)(item.Accept(this)));
                if ((acceptResult != null))
                {
                    list.Add(acceptResult);
                }
        ...
        /// </summary>
        public override AstRoot VisitAvailability_group_add_items(TSqlParser.Availability_group_add_itemsContext context)
        {
            TSqlParser.Availability_group_add_itemContext[] source = context.availability_group_add_item();
            AstAvailabilityGroupAddItems list = new AstAvailabilityGroupAddItems(context, source.Length);
            for (var enumerator = source.GetEnumerator(); enumerator.MoveNext(); 
            )
            {
                TSqlParser.Availability_group_add_itemContext item = ((TSqlParser.Availability_group_add_itemContext)(enumerator.Current));
                AstAvailabilityGroupAddItem acceptResult = ((AstAvailabilityGroupAddItem)(item.Accept(this)));
                if ((acceptResult != null))
                {
                    list.Add(acceptResult);
                }
        ...
        /// </summary>
        public override AstRoot VisitAvailability_group_update_items(TSqlParser.Availability_group_update_itemsContext context)
        {
            TSqlParser.Availability_group_update_itemContext[] source = context.availability_group_update_item();
            AstAvailabilityGroupUpdateItems list = new AstAvailabilityGroupUpdateItems(context, source.Length);
            for (var enumerator = source.GetEnumerator(); enumerator.MoveNext(); 
            )
            {
                TSqlParser.Availability_group_update_itemContext item = ((TSqlParser.Availability_group_update_itemContext)(enumerator.Current));
                AstAvailabilityGroupUpdateItem acceptResult = ((AstAvailabilityGroupUpdateItem)(item.Accept(this)));
                if ((acceptResult != null))
                {
                    list.Add(acceptResult);
                }
        ...
        /// </summary>
        public override AstRoot VisitAvailability_group_update_options(TSqlParser.Availability_group_update_optionsContext context)
        {
            TSqlParser.Listener_url_setContext[] source = context.listener_url_set();
            AstAvailabilityGroupUpdateOptions list = new AstAvailabilityGroupUpdateOptions(context, source.Length);
            for (var enumerator = source.GetEnumerator(); enumerator.MoveNext(); 
            )
            {
                TSqlParser.Listener_url_setContext item = ((TSqlParser.Listener_url_setContext)(enumerator.Current));
                AstListenerUrlSet acceptResult = ((AstListenerUrlSet)(item.Accept(this)));
                if ((acceptResult != null))
                {
                    list.Add(acceptResult);
                }
        ...
        /// </summary>
        public override AstRoot VisitEvent_type_or_group_ids(TSqlParser.Event_type_or_group_idsContext context)
        {
            TSqlParser.Event_type_or_group_idContext[] source = context.event_type_or_group_id();
            AstEventTypeOrGroupIds list = new AstEventTypeOrGroupIds(context, source.Length);
            for (var enumerator = source.GetEnumerator(); enumerator.MoveNext(); 
            )
            {
                TSqlParser.Event_type_or_group_idContext item = ((TSqlParser.Event_type_or_group_idContext)(enumerator.Current));
                AstEventTypeOrGroupId acceptResult = ((AstEventTypeOrGroupId)(item.Accept(this)));
                if ((acceptResult != null))
                {
                    list.Add(acceptResult);
                }
        ...
        /// </summary>
        public override AstRoot VisitEvent_session_properties(TSqlParser.Event_session_propertiesContext context)
        {
            TSqlParser.Event_session_propertyContext[] source = context.event_session_property();
            AstEventSessionProperties list = new AstEventSessionProperties(context, source.Length);
            for (var enumerator = source.GetEnumerator(); enumerator.MoveNext(); 
            )
            {
                TSqlParser.Event_session_propertyContext item = ((TSqlParser.Event_session_propertyContext)(enumerator.Current));
                AstEventSessionProperty acceptResult = ((AstEventSessionProperty)(item.Accept(this)));
                if ((acceptResult != null))
                {
                    list.Add(acceptResult);
                }
        ...
        {
            TSqlParser.Alter_login_sql_server_settingContext[] source = context.alter_login_sql_server_setting();
            AstAlterLoginSqlServerSettings list = new AstAlterLoginSqlServerSettings(context, source.Length);
            for (var enumerator = source.GetEnumerator(); enumerator.MoveNext(); 
            )
            {
                TSqlParser.Alter_login_sql_server_settingContext item = ((TSqlParser.Alter_login_sql_server_settingContext)(enumerator.Current));
                AstAlterLoginSqlServerSetting acceptResult = ((AstAlterLoginSqlServerSetting)(item.Accept(this)));
                if ((acceptResult != null))
                {
                    list.Add(acceptResult);
                }
