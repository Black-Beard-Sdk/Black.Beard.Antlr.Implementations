#nullable disable
// Generated by ScriptClassVisitorTerminalAlias.cs (Monday, May 8, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Parser
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        /// </summary>
        public override AstRoot VisitWith_no_dependents(TSqlParser.With_no_dependentsContext context)
        {
            return new AstWithNoDependents(context);
        }
        
        /// <summary>
        /// remove_private_key : REMOVE  PRIVATE  KEY
        /// </summary>
        public override AstRoot VisitRemove_private_key(TSqlParser.Remove_private_keyContext context)
        {
            return new AstRemovePrivateKey(context);
        }
        
        /// <summary>
        /// remove_provider_key : REMOVE  PROVIDER  KEY
        /// </summary>
        public override AstRoot VisitRemove_provider_key(TSqlParser.Remove_provider_keyContext context)
        {
            return new AstRemoveProviderKey(context);
        }
        
        /// <summary>
        /// force_regenerate : FORCE
        /// </summary>
        public override AstRoot VisitForce_regenerate(TSqlParser.Force_regenerateContext context)
        {
            return new AstForceRegenerate(context);
        }
        
        /// <summary>
        /// delete_from : FROM
        /// </summary>
        public override AstRoot VisitDelete_from(TSqlParser.Delete_fromContext context)
        {
            return new AstDeleteFrom(context);
        }
        
        /// <summary>
        /// into_statment : INTO
        /// </summary>
        public override AstRoot VisitInto_statment(TSqlParser.Into_statmentContext context)
        {
            return new AstIntoStatment(context);
        }
        ...
        /// </summary>
        public override AstRoot VisitWith_override(TSqlParser.With_overrideContext context)
        {
            return new AstWithOverride(context);
        }
        
        /// <summary>
        /// with_nowait : WITH  NOWAIT
        /// </summary>
        public override AstRoot VisitWith_nowait(TSqlParser.With_nowaitContext context)
        {
            return new AstWithNowait(context);
        }
