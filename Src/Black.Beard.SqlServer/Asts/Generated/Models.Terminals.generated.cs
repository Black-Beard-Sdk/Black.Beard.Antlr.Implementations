#nullable disable
// Generated by ScriptClassTerminals.cs (Sunday, April 30, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Asts
{
    ...
    public partial class AstLocalDrive : AstTerminalString
    {
        ...
        public override void ToString(Writer writer)
        {
            ...
            try
            {
                writer.Append(Constants.DISK_DRIVE);
            }
            finally
            {
                blockStrategy.Dispose();
    ...
    public partial class AstEmptyValue : AstTerminalString
    {
        ...
        public override void ToString(Writer writer)
        {
            ...
            try
            {
                writer.Append(Constants.DOUBLE_QUOTE_ID);
            }
            finally
            {
                blockStrategy.Dispose();
    ...
    public partial class AstIpv4 : AstTerminalString
    {
        ...
        public override void ToString(Writer writer)
        {
            ...
            try
            {
                writer.Append(Constants.IPV4_ADDR);
            }
            finally
            {
                blockStrategy.Dispose();
    ...
    public partial class AstIpv6 : AstTerminalString
    {
        ...
        public override void ToString(Writer writer)
        {
            ...
            try
            {
                writer.Append(Constants.IPV6_ADDR);
            }
            finally
            {
                blockStrategy.Dispose();
    ...
    public partial class AstDecimal : AstTerminalDecimal
    {
        ...
        public override void ToString(Writer writer)
        {
            ...
            try
            {
                writer.Append(Constants.DECIMAL);
            }
            finally
            {
                blockStrategy.Dispose();
    ...
    public partial class AstBinary : AstTerminalString
    {
        ...
        public override void ToString(Writer writer)
        {
            ...
            try
            {
                writer.Append(Constants.BINARY);
            }
            finally
            {
                blockStrategy.Dispose();
    ...
    public partial class AstLocalId : AstTerminalString
    {
        ...
        public override void ToString(Writer writer)
        {
            ...
            try
            {
                writer.Append(Constants.LOCAL_ID);
            }
            finally
            {
                blockStrategy.Dispose();
    ...
    public partial class AstStringtext : AstTerminalString
    {
        ...
        public override void ToString(Writer writer)
        {
            ...
            try
            {
                writer.Append(Constants.STRING);
            }
            finally
            {
                blockStrategy.Dispose();
    ...
    public partial class AstParameter : AstBnfRule
    {
        ...
        public override void ToString(Writer writer)
        {
            ...
            try
            {
                writer.Append(Constants.PLACEHOLDER);
            }
            finally
            {
                blockStrategy.Dispose();
