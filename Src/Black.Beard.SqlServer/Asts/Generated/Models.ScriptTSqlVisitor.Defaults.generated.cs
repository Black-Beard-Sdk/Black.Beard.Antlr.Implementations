#nullable disable
// Generated by ScriptClassVisitorDefaults.cs (vendredi 28 avril 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Parser
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        /// 	 : (PASSWORD  EQUAL  pwd_value  pwd_strategies?)?  (COMMA?  SID  EQUAL  sid = binary_)?  (COMMA?  DEFAULT_DATABASE  EQUAL  database_id)?  (COMMA?  default_language_set)?  (COMMA?  CHECK_EXPIRATION  EQUAL  check_expiration = on_off)?  (COMMA?  CHECK_POLICY  EQUAL  check_policy = on_off)?  (COMMA?  CREDENTIAL  EQUAL  credential_id)?
        /// </summary>
        ...
        /// <summary>
        /// alter_server_configuration
        /// 	 : ALTER  SERVER  CONFIGURATION  SET  (server_config_process_affinity | server_config_diagnostic_log | server_config_failover | server_config_hadr_set | server_config_buffer_pool_ext | SET  SOFTNUMA  on_off)
        /// </summary>
        ...
        /// 	 : PROCESS  AFFINITY  (process_cpu_set | process_numanode_set)
        /// </summary>
        ...
        /// 	 : DIAGNOSTICS  LOG  (on_off | diagnos_path_set | diagnos_max_size_set | diagnos_max_files_set)
        /// </summary>
        ...
        /// <summary>
        /// filename_set
        /// 	 : FILENAME  EQUAL  file = stringtext
        /// </summary>
        ...
        /// 	 : BUFFER  POOL  EXTENSION  (ON  LR_BRACKET  filename_set  COMMA  SIZE  EQUAL  size = decimal  size_unity  RR_BRACKET | OFF)
        /// </summary>
