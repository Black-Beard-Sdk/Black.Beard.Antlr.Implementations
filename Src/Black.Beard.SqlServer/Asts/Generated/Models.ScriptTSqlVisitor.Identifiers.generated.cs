#nullable disable
// Generated by ScriptClassVisitorIdentifier.cs (Sunday, April 16, 2023)
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bb.SqlServer.Parser
{
    ...
    public partial class ScriptTSqlVisitor
    {
        ...
        public override AstRoot VisitPwd(TSqlParser.PwdContext context)
        {
            ...
            if ((arg0 != null))
            {
                return new AstPwd(context, ((AstStringtext)(this.VisitStringtext(arg0))));
            }
            return null;
        }
        ...
        public override AstRoot VisitSchema_identifier(TSqlParser.Schema_identifierContext context)
        {
            ...
            if ((arg0 != null))
            {
                return new AstSchemaIdentifier(context, ((AstId)(this.VisitId_(arg0))));
            }
            return null;
        }
        ...
        public override AstRoot VisitLanguage_id(TSqlParser.Language_idContext context)
        {
            ...
            if ((arg0 != null))
            {
                return new AstLanguageId(context, ((AstId)(this.VisitId_(arg0))));
            }
            return null;
        }
        ...
        public override AstRoot VisitContract_id(TSqlParser.Contract_idContext context)
        {
            ...
            if ((arg0 != null))
            {
                return new AstContractId(context, ((AstId)(this.VisitId_(arg0))));
            }
            return null;
        }
        ...
        public override AstRoot VisitObject_identifier(TSqlParser.Object_identifierContext context)
        {
            ...
            if ((arg0 != null))
            {
                return new AstObjectIdentifier(context, ((AstId)(this.VisitId_(arg0))));
            }
            return null;
        }
        ...
        public override AstRoot VisitTransaction_identifier(TSqlParser.Transaction_identifierContext context)
        {
            ...
            if ((arg0 != null))
            {
                return new AstTransactionIdentifier(context, ((AstId)(this.VisitId_(arg0))));
            }
            return null;
        }
