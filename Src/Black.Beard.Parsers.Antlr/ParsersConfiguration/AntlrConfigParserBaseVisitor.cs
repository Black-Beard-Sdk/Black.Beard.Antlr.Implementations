...
public partial class AntlrConfigParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IAntlrConfigParserVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitCalculated_rule_tune_inherit([NotNull] AntlrConfigParser.Calculated_rule_tune_inheritContext context) { return VisitChildren(context); }
	/// <summary>
