...
namespace Generate.ModelsScripts
{
    ...
    public class GenerateToString : GenerateCode
    {

        public GenerateToString(CodeStatementCollection code, string strategy)
            : base(code, strategy)
        {
        ...
        public static CodeExpression Generate(AstRule ast, CodeStatementCollection code)
        {
            ...
            var visitor = new GenerateToString(code, strategy);
